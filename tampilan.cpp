...
void userMenu(listCom &L){
    ...
    while (choice != 0) {
        ...
        cout << "2. menampilkan data composer berdasarkan genre\n";      
        cout << "3. menampilkan data composer berdasarkan negara\n";          
        cout << "4. menampilkan semua data music dalam list\n";         
        cout << "5. menampilkan data music berdasarkan genre\n";              
        cout << "6. menampilkan semua music dari suatu composer\n"; 
        cout << "7. composer yang paling produktif\n"; 
        cout << "0. Exit Admin Selection\n";
        cout << "==============================\n";
        cout << "Pilih menu: ";
        cin >> choice;
